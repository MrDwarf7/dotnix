...
in {
  options = {
    home.river.enable = lib.mkEnableOption "Enable river (config)";
  };

  config = lib.mkIf config.home.river.enable {
    wayland.windowManager.river = let
      # TODO: Double check basically everything in this file
      locked = {
